...
## Egna anteckningar
World Time API och Programming Quotes API är mycket långsamma/opålitliga. Använd ett Date()-objekt respektive http://quotes.stormconsultancy.co.uk/random.json istället.
Det finns en figma-fil där ni kan kolla på designen, filen heter clock-app.fig. Figma är ett mycket vanligt verktyg för UX/UI designers och kan laddas ner gratis via https://www.figma.com/.
